import { MetricResult, Range } from '@insight/shared';
import { GeminiProvider, ProviderRegistry, generateText } from './provider';
...
export const generateInsights = async (
  ...
  try {
    ...
    const prompt = `
      ...
      Date Range: ${range.dateFrom.toLocaleDateString()} to ${range.dateTo.toLocaleDateString()}
